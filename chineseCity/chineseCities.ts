/**
 * 中国城市数据
 * @see http://www.mca.gov.cn/article/sj/xzqh/1980/
 */
export const chineseCities = {
	/** 所有地区 */
	"areas": {
		"华北地区": "北京市|天津市|河北省|山西省|内蒙古自治区|辽宁省|吉林省|黑龙江省",
		"华东地区": "上海市|江苏省|浙江省|安徽省|福建省|江西省|山东省",
		"华中地区": "河南省|湖北省|湖南省|重庆市|四川省",
		"华南地区": "广东省|广西壮族自治区|海南省|贵州省|云南省",
		"华西地区": "西藏自治区|陕西省|甘肃省|青海省|宁夏回族自治区|新疆维吾尔自治区",
	...
	"provinces": {
		...
		"新疆维吾尔自治区": "乌鲁木齐市|克拉玛依市|吐鲁番市|哈密市|昌吉回族自治州|博尔塔拉蒙古自治州|巴音郭楞蒙古自治州|阿克苏地区|克孜勒苏柯尔克孜自治州|喀什地区|和田地区|伊犁哈萨克自治州|塔城地区|阿勒泰地区|新星市"
	},
	/** 所有地级市/州 */
	"cities": {
		...
		"杭州市": "上城区|钱塘区|拱墅区|西湖区|滨江区|萧山区|余杭区|富阳区|临安区|桐庐县|淳安县|建德市|临平区",
		...
		"三明市": "三元区|明溪县|清流县|宁化县|大田县|尤溪县|沙县区|将乐县|泰宁县|建宁县|永安市",
		...
		"洛阳市": "老城区|西工区|瀍河回族区|涧西区|洛龙区|孟津区|新安县|栾川县|嵩县|汝阳县|宜阳县|洛宁县|伊川县|偃师区|伊滨经开区",
		...
		"随州市": "曾都区|随县|广水市",
		"恩施土家族苗族自治州": "恩施市|利川市|建始县|巴东县|宣恩县|咸丰县|来凤县|鹤峰县|仙桃市|潜江市|天门市|神农架林区",
		...
		"重庆市": "万州区|涪陵区|渝中区|大渡口区|江北区|沙坪坝区|九龙坡区|南岸区|北碚区|綦江区|大足区|渝北区|巴南区|黔江区|长寿区|江津区|合川区|永川区|南川区|璧山区|铜梁区|潼南区|荣昌区|开州区|梁平区|武隆区|城口县|丰都县|垫江县|忠县|云阳县|奉节县|巫山县|巫溪县|石柱土家族自治县|秀山土家族苗,族自治县|酉阳土家族苗族自治县|彭水苗族土家族自治县",
		...
		"阿勒泰地区": "阿勒泰市|布尔津县|富蕴县|福海县|哈巴河县|青河县|吉木乃县|石河子市|阿拉尔市|图木舒克市|五家渠市|北屯市|铁门关市|双河市|可克达拉市|昆玉市|胡杨河市"
	}
}