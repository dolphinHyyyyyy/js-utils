...
export function formatTest() {
	assert.strictEqual(date.formatDate(new Date("2016/01/01 00:00:00")), "2016-01-01 00:00:00")
	assert.strictEqual(date.formatDate(new Date("2016/01/01 00:00:00"), "yyyyMMdd"), "20160101")
}

export function parseTest() {
	assert.strictEqual(+date.parseDate("2014-1-1"), +new Date("2014/1/1"))
	assert.strictEqual(+date.parseDate("20140101"), +new Date("2014/1/1"))
	assert.strictEqual(+date.parseDate("2014年1月1日", "yyyy年MM月dd日"), +new Date("2014/1/1"))
}
...
export function isValidTest() {
	assert.strictEqual(date.isValidDate(2004, 2, 29), true)
}
...
export function formatDateToChineseTest() {
	assert.strictEqual(date.formatChineseRelativeDate(new Date()), "刚刚")
}