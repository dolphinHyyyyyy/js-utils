/**
 * 将繁体中文转为简体中文，无法转换的字符将保留不变
 * @param value 要转换的繁体中文
 * @returns 返回转换后的中文。无法转换的字符将保留不变
 * @example toSimpleChinese("簡体") // "简體"
 */
export function toSimpleChinese(value: string) {
	return convert(value, traditionalChineseDict, simpleChineseDict)
}

/**
 * 将简体中文转为繁体中文，无法转换的字符将保留不变
 * @param value 要转换的简体中文
 * @example toTradionalChinese("简體") // "簡体"
 */
export function toTraditionalChinese(value: string) {
	return convert(value, simpleChineseDict, traditionalChineseDict)
}
 ...
 * @internal
 */
export const simpleChineseDict =
 ...
 * @internal
 */
export const traditionalChineseDict =
