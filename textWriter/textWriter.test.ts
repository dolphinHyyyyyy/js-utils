...
import * as sourceMap from "../sourceMap/sourceMap"
import { SourceMapTextWriter } from "./soureMapTextWriter"
...
export function mergeSourceMapTest4() {
	...
	const writer1 = new SourceMapTextWriter()
	...
	const writer2 = new SourceMapTextWriter()
	...
	const writer3 = new SourceMapTextWriter()
