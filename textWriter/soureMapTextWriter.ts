import { SourceMapBuilder, SourceMapData, toSourceMapBuilder } from "../sourceMap/sourceMap"
...
export class SourceMapTextWriter extends TextWriter {
	 ...
	 */
	override write(content: string, startIndex = 0, endIndex = content.length, sourcePath?: string | number, sourceLine?: number, sourceColumn?: number, name?: string | number, sourceMap?: SourceMapData) {
		let line = this.line
