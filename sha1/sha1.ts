 ...
 * 计算字符串的 SHA-1 值（小写）
 * @param value 要计算的字符串
 * @returns 返回 40 位的全小写 SHA-1 值
 * @example sha1("abc") // "a9993e364706816aba3e25717850c26c9cd0d89d"
 */
export function sha1(value: string) {
	return binaryToString(sha1Binary(stringToBinary(value)))
}

/**
 * 将 ASCII 字符转为字节数组
 * @param value 相关的文本
 * @description 如果字符编码大于 255 则高位会被截断
 * @internal
 */
...
/**
 * 编码使用的字符集
 * @description 如果需要更改加密返回的字母大小写可更改此字段
 * @internal
 */
 ...
 * @internal
 */
export function sha1Binary(value: number[]) {
